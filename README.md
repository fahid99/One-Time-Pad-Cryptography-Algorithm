...
There are two functions within this code: encrypt() and decrypt()
  ...
  - decrypt() has two parameters: ciphertext and key (of string type). You use the same key used to encrypt the cleartext to decripyt the ciphertext. You return the cleartext.
